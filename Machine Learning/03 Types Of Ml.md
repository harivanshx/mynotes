...
1. Clustering :
![[Pasted image 20251031100237.png]]

Divide Datapoints into group , it is a powerful technique 
...
1. Dimensionality Reduction :
	If we have a 1000 input column and we dont need that much input column so we remove the seperate column by feature extraction and remove those extra column . 

	For graph Plotting we use only few  2 - 3 data columns for our graph 



2. Anomaly Detection :
	for normal data points we 



![[Pasted image 20251031100618.png]]



	Anomaly Detaction works on the data points which exceed the limit of the data
	These data points are too far from the similar data points and it can create chaos in the model and can influence our result


3. Association :

	Properly organized products is a problem :
...
Alpha Go wins the  Go game by beating the world champion in that game \
...
![[Pasted image 20251031101542.png]]
